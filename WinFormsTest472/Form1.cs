...
namespace WinFormsTest472
{
    public partial class Form1 : Form
    {
        ...
        private void btnCheckBox_Click(object sender, EventArgs e)
        {
            ...
            box.Show(this);
            // After Show returns, box.IsCheckBoxChecked reflects the user's choice.
        ...
        private void btnHelpLink_Click(object sender, EventArgs e)
        {
            ...
            // The MS dialog reads the HelpLink via reflection and surfaces a Help button.
            Show(ex);
        }
        ...
        {
            return new InvalidOperationException("Sample exception for testing the dialog.");
        }

        private static Exception ConfirmException()
        {
            return new InvalidOperationException("Do you want to retry the operation?");
        }
